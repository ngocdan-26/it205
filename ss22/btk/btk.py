...
def get_shipping_rate(method: str, distance: int) -> float:
    ...
    if distance <= 0:
        ...
        # return 0.0
        raise ValueError("Khoảng cách vận chuyển không được nhỏ hơn hoặc bằng 0")
...
# sử dụng try except để chạy Intern
if __name__ == "__main__":
    try:
        cost = calculate_final_shipping(3.5, 25, "express")
        print(f"Phí vận chuyển: {cost}")
